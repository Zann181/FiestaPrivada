    ...
    if (hasToken) {
        return (
            <View style={styles.menuContainer}>
                ...
                <TouchableButton title="Añadir Asistente" onPress={handleAdd} style={styles.smallButton} />
                <TouchableButton title="Ver Asistentes" onPress={handleShowList} style={styles.smallButton} />
